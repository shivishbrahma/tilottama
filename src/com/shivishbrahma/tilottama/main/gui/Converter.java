...
public class Converter extends Gui {
		...
		tempConv = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (fromUnit.equalsIgnoreCase(toUnit)) {
					...
					fromVal.setText(com.shivishbrahma.tilottama.main.par.Temperature.temperatureFormat(fromUnit.charAt(0), fromValue));
					toVal.setText(com.shivishbrahma.tilottama.main.par.Temperature.temperatureFormat(toUnit.charAt(0), fromValue));
				} else {
					double toValue = com.shivishbrahma.tilottama.main.par.Temperature.temperatureConv(getCharTemperature(fromUnit),
							getCharTemperature(toUnit), fromValue);
					toText.setText(String.format("%.3f", toValue));
					fromVal.setText(com.shivishbrahma.tilottama.main.par.Temperature.temperatureFormat(fromUnit.charAt(0), fromValue));
					toVal.setText(com.shivishbrahma.tilottama.main.par.Temperature.temperatureFormat(toUnit.charAt(0), toValue));
				}
			}
		};
	...
	public void initCurrency() {
		List<Currency> currList = com.shivishbrahma.tilottama.main.par.CurrencyHandler.getCurrencies();
		fromSelect.removeAllItems();
		...
		currConv = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (fromUnit == toUnit) {
					toText.setText(Double.toString(fromValue));
					fromVal.setText(com.shivishbrahma.tilottama.main.par.CurrencyHandler
							.getCurrencyString(currList.get(fromUnit).getCurrencyCode(), fromValue));
					toVal.setText(com.shivishbrahma.tilottama.main.par.CurrencyHandler
							.getCurrencyString(currList.get(fromUnit).getCurrencyCode(), fromValue));
				} else {
