...
public class CalendarApp {
	...
	public void getEvents(String day) {
		...
		try {
			...
			System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.centerAligned("Events", 64, "#"));
			for (Element event : events) {
				String s = event.text();
				System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.wrapString(s, 80));
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void getBirths(String day) {
		...
		try {
			...
			System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.centerAligned("Births", 64, "#"));
			for (Element event : events) {
				String s = event.text();
				System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.wrapString(s, 80));
			}
	...
	public void getDeaths(String day) {
		...
		try {
			...
			System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.centerAligned("Deaths", 64, "#"));
			for (Element event : events) {
				String s = event.text();
				System.out.println(com.shivishbrahma.tilottama.main.par.StringHandler.wrapString(s, 80));
			}
